...
canonical: https://tooljump.dev/integrations/github-aws-infrastructure
slides:
  - image: /img/slide-github.png
    alt: Github
    url: https://github.com/mycompany/webshop
    targetSpanIndex: 1
    description: View Lambda functions tagged to this repo—no console hunting
    data:
      - type: dropdown
  ...
  - image: /img/slide-aws-lambda.png
    ...
    targetSpanIndex: 1
    description: Open the Lambda for this repo directly in AWS Console
    isLastSlide: true
    data:
      - type: text
        content: Other integrations ...
...
<StructuredData 
  type="Article" 
  data={{
    headline: "GitHub → AWS: Show infrastructure (Lambdas) for this repo",
    description: "Connect GitHub repositories with AWS Lambda infrastructure. See deployed Lambda functions, costs, and monitoring data directly from your GitHub repository page.",
    url: "https://tooljump.dev/integrations/github-aws-infrastructure",

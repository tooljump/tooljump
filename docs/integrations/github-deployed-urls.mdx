...
icons: [github, link]
keywords: [github deployed urls, service endpoints, staging production urls, github deployment, environment urls]
description: GitHub integration that shows deployed service URLs for staging and production environments directly from your repository page.
slides:
  - image: /img/slide-github.png
    alt: Github
    url: https://github.com/mycompany/webshop
    targetSpanIndex: 1
    description: Open staging and production URLs for this service instantly
    data:
      - type: dropdown
  ...
  - image: /img/slide-webshop.png
    ...
    description: Here's the deployed URL for this service
    isLastSlide: true
    data:
      - type: text
        content: Other integrations ...

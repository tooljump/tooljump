...
icons: [aws, github]
keywords: [aws lambda github integration, deployed code, lambda version, aws github, code deployment tracking]
description: AWS Lambda integration that shows the exact GitHub repository and version deployed to your Lambda function, enabling quick code navigation and debugging.
slides:
  - image: /img/slide-aws-lambda.png
    ...
    targetSpanIndex: 1
    description: Jump to the exact Git commit deployed to this Lambda
    data:
      - type: link

...
keywords: [result types, integration result types, tooljump data types, integration output, data display]
description: Learn about ToolJump integration result types including links, text, dropdowns, and other data display formats for your custom integrations.
---

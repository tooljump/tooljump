...
keywords: [hello world integration, tooljump tutorial, first integration, integration example, custom integration]
description: Create your first ToolJump integration with this step-by-step Hello World tutorial. Learn the basics of integration development and data display.
---

import BarContentPreview from '@site/src/components/BarContentPreview';
import ConditionalQueryParam from '@site/src/components/ConditionalQueryParam';

<ConditionalQueryParam param="from_extension">

:::tip Welcome to ToolJump Demo Integration

You clicked on a tool from the context bar - nice! 

In a live environment, this button would take you directly to the tool you wanted.

Since this is a demo integration that does not have the context of your organisation, please read below how to create your own integrations, adapted for your use-cases, or review the [demos](/docs/demos) section for inspiration
...
Browse [integration recipes](/docs/recipes) for tool-specific implementation patterns.
